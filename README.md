...
Java와 Spring Boot로 도메인 API를 개발해 왔습니다. 데이터 조회 방식과 Redis 캐시의 정합성을 개선하고 배포 과정에서 생긴 문제를 해결한 경험이 있습니다.

AI 에이전트에 기존 코드와 API 규칙을 제공해 기능을 구현하고 오류를 분석했습니다. 구현 결과는 로그와 테스트로 확인했습니다.

Dayori에서는 백엔드 개발과 인프라를 맡았습니다. 부팀장으로서 팀의 일정을 조율하며 앱 출시와 운영까지 참여했습니다.
